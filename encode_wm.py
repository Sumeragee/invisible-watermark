...
# === Input image ===
input_file = 'Screenshot(12).png' # <-- Input Filename here to be embedded with INV WM
watermark_text = 'VALO'  # Must be exactly 4 chars for rivaGan/ 32 bit lang rivaGan
algorithm = 'rivaGan'
